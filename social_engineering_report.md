...
1.Phishing: This is the most common attack I found. Attackers send deceptive emails that look official to trick users into clicking malicious links or sharing login credentials.

2.Pretexting: In this scenario, the attacker creates a fabricated story (a pretext) to gain the victim’s trust. For example, they might pretend to be from the HR department needing to "verify" your bank details.
...
1.Security Awareness Training: We must teach people to stay skeptical of "urgent" requests for information.

2.Verify via Different Channels: If you get a suspicious email from a boss, call them or message them on a different platform to confirm it’s really them.

3.Enforce Multi-Factor Authentication (MFA): This is a critical safety net. Even if an attacker steals a password through phishing, they still cannot access the account without the second code.
